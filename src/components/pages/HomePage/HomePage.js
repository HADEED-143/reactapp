...
const handleRequestDemoClass = () => {
    window.location.href = 'https://api.whatsapp.com/send?phone=123456789&text=Hello%2C%20I%20would%20like%20to%20request%20a%20demo%20class.';
};
const HomePage = () => (
        ...
        <div className='home-flex'>
            <section className='section-one-flex'>
                <div>
                    ...
                    <button className='btn-1 mt2 font-secondary section-one-btn font-500' onClick={handleRequestDemoClass}>REQUEST DEMO CLASS</button>
                </div>
                <img
